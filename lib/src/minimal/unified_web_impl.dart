...
/// Web-specific SQLite implementation using universal_ffi WASM support
class MinimalSqliteUnifiedImpl implements MinimalSqliteApi {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _sqlite3_bind_int = _helper!.library
      ...
      _sqlite3_bind_null = _helper!.library
